...
|--------|:------------:|:--------------------:|
| 지수 (S&P500·나스닥·코스피 등) | 5분 | 5분마다 백그라운드 갱신 |
| 종목 랭킹 (거래량·거래대금 순위) | 5분 | 5분마다 백그라운드 갱신 |
| 관심종목 현재가 (`/api/quotes`) | 5분 | 없음 — 페이지 진입 시 1회 |
| 현재가 (`/api/prices`) | 5분 | 없음 — 페이지 진입 시 1회 |
